...
# import importlib
# importlib.reload(create_gears_holes)
...
for k in range(nbharmonics):
 ...
 trou=FreeCAD.ActiveDocument.addObject("Part::Cylinder","trou"+str(k))
 trou.Height=1
 trou.Radius=1
 rouetrou=FreeCAD.ActiveDocument.addObject("Part::Cut","Cut")
 rouetrou.Base=tmprouepignon;  #FreeCAD.ActiveDocument.Cut.Base = tmpcube1
 rouetrou.Tool=trou
 rouepignon.append(rouetrou)
 if (k>0):
  ...
  trouinter=FreeCAD.ActiveDocument.addObject("Part::Cylinder","trouinter"+str(k))
  trouinter.Height=1
  trouinter.Radius=1
  roueintertrouinter=FreeCAD.ActiveDocument.addObject("Part::Cut","Cut")
  roueintertrouinter.Base=roueinter;  #FreeCAD.ActiveDocument.Cut.Base = tmpcube1
  roueintertrouinter.Tool=trouinter
  roue2.append(roueintertrouinter)
