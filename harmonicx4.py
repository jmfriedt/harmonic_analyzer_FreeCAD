...
# fourth wheel
p14 = FreeCAD.ActiveDocument.getObject("Connect006")
h14 = FreeCAD.ActiveDocument.getObject("Connect007")
c04 = FreeCAD.ActiveDocument.getObject("Cylinder008")
c14 = FreeCAD.ActiveDocument.getObject("Cylinder009")
spring4 = FreeCAD.ActiveDocument.getObject("Box013")
p1init4=p14.Placement
h1init4=h14.Placement
springinit4=spring4.Placement
leninit4=spring4.Width
...
def update_harmonic():
  ...
  alpha4 = radians(7*i)
  y4 = c14.Placement.Base.x*(sin( alpha4 ))
  p14.Placement = FreeCAD.Placement( p1init4.Base , FreeCAD.Rotation ( FreeCAD.Vector( 0,0,1), i*7) )
  h14.Placement = FreeCAD.Placement( h1init4.Base + FreeCAD.Vector( 0, y4, 0 ) , h1init4.Rotation )
  spring4.Placement = FreeCAD.Placement( springinit4.Base + FreeCAD.Vector( 0, y4, 0 ) , h1init4.Rotation )
  #spring4.Width=leninit2.Value-y4
  
  yvar=(y1+y2/5+y3/3)/2  # triangle
  yvar=(y1+y2+y3+y4)/2   # square: la force de rappel est un terme constant -yrappel
